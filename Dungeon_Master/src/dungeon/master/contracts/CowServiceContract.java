...
import dungeon.master.decorators.CowServiceDecorator;
...
public class CowServiceContract extends CowServiceDecorator implements CowService {
	
	public CowServiceContract(CowService delegate) {
		super(delegate);
	}
