...
import dungeon.master.decorators.MonsterServiceDecorator;
...
public class MonsterServiceContract extends MonsterServiceDecorator implements MonsterService {

	public MonsterServiceContract(MonsterService delegate) {
		super(delegate);
	}
